  ...
  <div class="flex flex-col gap-4">
    <div class="flex flex-col md:flex-row gap-2">
      <div class="flex flex-col gap-2 flex-1">
        ...
        <InputText id="name" placeholder="Seu nome aqui" v-model="user.name" />
        <small v-if="props.errors?.name">{{ props.errors?.name._errors[0] }}</small>
      </div>

      <div class="flex flex-col gap-2 flex-1">
        <label for="site">Site</label>
        <InputText id="site" placeholder="seusite.com" v-model="user.site" />
    ...
    <div class="flex flex-col md:flex-row gap-2">
      <div class="flex flex-col gap-2 flex-1">
        <label for="name">Nome</label>
        <InputText id="name" placeholder="Seu nome aqui" v-model="user.bio" />
        <small v-if="props.errors?.bio">{{ props.errors?.bio._errors[0] }}</small>
      </div>
      <div class="flex flex-col gap-2 flex-1">
        <label for="phone">Telefone</label>
        <InputText id="phone" placeholder="Seu telefone aqui" v-model="user.phone" />
